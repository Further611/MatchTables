...
class HomeViewController: UIViewController {
    ...
    @IBAction func btnLearn(_ sender: Any) {
        let view = SelectNumberViewController(nibName: "SelectNumberViewController", bundle: nil)
        present(view, animated: true, completion: nil)
    }
    
    @IBAction func btnMake(_ sender: Any) {
        let view = MakeTableViewController(nibName: "MakeTableViewController", bundle: nil)
        present(view, animated: true, completion: nil)
    }
    
    @IBAction func btnPlay(_ sender: Any) {
        let view = PlayViewController(nibName: "PlayViewController", bundle: nil)
        present(view, animated: true, completion: nil)
    }
    
    @IBAction func btnScore(_ sender: Any) {
        let view = ScoreViewController(nibName: "ScoreViewController", bundle: nil)
        present(view, animated: true, completion: nil)
    }
}
