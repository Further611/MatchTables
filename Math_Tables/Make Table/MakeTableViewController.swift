...
class MakeTableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let nib1 = UINib(nibName: "LearnTableViewCell", bundle: nil)
        tableView.register(nib1, forCellReuseIdentifier: tbCell)
        ...
        let nib2 = UINib(nibName: "ResultCollectionViewCell", bundle: nil)
        collectionView.register(nib2, forCellWithReuseIdentifier: cvCell)
...
extension MakeTableViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return resultList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: tbCell) as! LearnTableViewCell
...
extension MakeTableViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return tableView.frame.height / CGFloat(multiplier.count)
    }
}

extension MakeTableViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.lbResult.layer.cornerRadius = 20
        cell.lbResult.clipsToBounds = true
        cell.lbResult.text = String(resultArray[indexPath.item])
        return cell
    }
}

extension MakeTableViewController: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: collectionView.frame.width / 6, height: (collectionView.frame.height / 2) - 5)
    }
}
